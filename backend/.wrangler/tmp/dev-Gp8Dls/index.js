...
// .wrangler/tmp/bundle-zpezNf/checked-fetch.js
...
var require_edge2 = __commonJS({
  "node_modules/.prisma/client/edge.js"(exports) {
    ...
    var config = {
      ...
      "inlineSchemaHash": "62ce9147438d5b98beb5fa41b545df1d91aa96b3e1f5e502f085bb4acfcf90f1",
      "copyEngine": false
    };
    config.dirname = "/";
...
// .wrangler/tmp/bundle-zpezNf/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();

// .wrangler/tmp/bundle-zpezNf/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
...
userRouter.post("/signup", async (c) => {
  ...
  try {
    ...
    if (e.code === "P2002") {
      ...
      return c.json({ code: e.code, message: "Email already exists! try with different email" });
    }
