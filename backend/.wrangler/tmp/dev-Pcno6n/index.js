...
// .wrangler/tmp/bundle-CoQSJo/checked-fetch.js
...
// .wrangler/tmp/bundle-CoQSJo/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();

// .wrangler/tmp/bundle-CoQSJo/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
...
userRouter.post("/signup", async (c) => {
  ...
  try {
    ...
    console.log(e);
    return c.json({ e: "Something went wrong while signing up" });
  }
});
...
blogRouter.get("/bulk", async (c) => {
  ...
  try {
    ...
    console.error(e);
    return c.json({ error: "Something went wrong while fetching posts" });
  }
});
